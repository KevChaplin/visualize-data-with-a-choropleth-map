...
// Colors for showing the different education levels
const colors = ["hsl(270, 100%, 90%)", "hsl(270, 100%, 75%)", "hsl(270, 100%, 60%)", "hsl(270, 100%, 45%)", "hsl(270, 100%, 30%)"]
...
let drawMap = () => {
  ...
  canvas.selectAll("path")
          ...
          .attr("d", d3.geoPath())
          .attr("class", "county")
          // To access education level, county id (FIPS) is matched with education data FIPS
    ...
    // Legend of colors / education level
    canvas.append("g")
          .attr("id", "legend")
...
// Import data - map data is converted from topojson format; education data imported after map data
